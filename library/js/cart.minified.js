...
{e.preventDefault();var valid=!0;$("input[req]").removeAttr("style");$("input[req]").each(function()
{if($(this).val()=="")
...
{$(this).closest("form").submit()}});$("div.cart-info").find("div.button").on("click",function()
