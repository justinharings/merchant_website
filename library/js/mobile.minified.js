...
{$("div.sub-header-menu").find("ul.head").hide();$("div.sub-header-menu").find("div.filterForm").hide();$("div.sub-header-menu").find("span.fa-caret-up").removeClass("fa-caret-up").addClass("fa-caret-down");$("div.search-field").hide();if($(this).find("ul.header-menu").css("display")=="block")
{$(this).find("ul.header-menu").hide()}
else{$(this).find("ul.header-menu").show()}});$("div.sub-header-menu").on("click",function()
{$("div.main-header-menu").find("ul.header-menu").hide();$("div.sub-header-menu").find("div.filterForm").hide();$("div.sub-header-menu").find("span.fa-caret-up").removeClass("fa-caret-up").addClass("fa-caret-down");$("div.search-field").hide();if($(this).find("ul.head").css("display")=="block")
{$(this).find("ul.head").hide();$(this).find("span.fa-caret-up").removeClass("fa-caret-up").addClass("fa-caret-down")}
else{$(this).find("ul.head").show();$(this).find("span.fa-caret-down").removeClass("fa-caret-down").addClass("fa-caret-up")}});$("div.sub-header-menu.filter").on("click",function()
{$("div.main-header-menu").find("ul.header-menu").hide();$("div.sub-header-menu").find("ul.head").hide();$("div.sub-header-menu").find("span.fa-caret-up").removeClass("fa-caret-up").addClass("fa-caret-down");$("div.search-field").hide();if($(this).find("div.filterForm").css("display")=="block")
{$(this).find("div.filterForm").hide();$(this).find("span.fa-caret-up").removeClass("fa-caret-up").addClass("fa-caret-down")}
else{$(this).find("div.filterForm").show();$(this).find("span.fa-caret-down").removeClass("fa-caret-down").addClass("fa-caret-up")}})}}