...
function _mobile()
{
	...
	else if($(window).width() <= 830 && $("input#mobile").val() == 0)
	{
		...
		{
			var text = "informatie pagina's";
			
			if($("div.page-menu").find("ul.head").hasClass("catalog"))
			{
				text = "bekijk onze catalogus";
			}
			
			$("div.main-header-menu").parent().append('<div class="sub-header-menu"><span class="fa fa-caret-down"></span>&nbsp;&nbsp;' + text + '</div>');
			$("div.page-menu").find("ul.head").appendTo(".sub-header-menu");
		}
		
		if($("div.filters").length != 0)
		{
			$("div.main-header-menu").parent().append('<div class="sub-header-menu filter"><span class="fa fa-caret-down"></span>&nbsp;&nbsp;resultaten filteren</div>');
			$("div.filters").find("div.filterForm").appendTo(".sub-header-menu.filter");
		}
		
		$("ul.header-menu").appendTo(".main-header-menu");
		
		$("div.main-header-menu").on("click",
			function()
			{
				$("div.sub-header-menu").find("ul.head").hide();
				$("div.sub-header-menu").find("div.filterForm").hide();
				$("div.sub-header-menu").find("span.fa-caret-up").removeClass("fa-caret-up").addClass("fa-caret-down");
		...
		$("div.sub-header-menu").on("click",
			function()
			{
				$("div.main-header-menu").find("ul.header-menu").hide();
				$("div.sub-header-menu").find("div.filterForm").hide();
				$("div.sub-header-menu").find("span.fa-caret-up").removeClass("fa-caret-up").addClass("fa-caret-down");
		...
		$("div.sub-header-menu.filter").on("click",
			function()
			{
				$("div.main-header-menu").find("ul.header-menu").hide();
				$("div.sub-header-menu").find("ul.head").hide();
